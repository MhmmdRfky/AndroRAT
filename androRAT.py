...
print("\tHarap Sabar\n(Tools Akan Dimulai Dalam 10 Detik)")
...
import webbrowser
get_url=webbrowser.open('https://www.youtube.com/watch?v=DPOYyKqIk1w')
#!/usr/bin/python
# -*- coding: utf-8 -*-
...
#                                        - By Muhammad Rifky Maulana


print('Terima Kasih Udah Mau Subscribe 😊\nSemoga Lancar\nTnk"s')
